        ...
        <div className='max-w-[450px] mx-auto h-[600px] bg-black/75 text-white'>
          <div className='max-w-[320px] mx-auto py-16'>
            ...
            <form onSubmit={handleSubmit} className='flex flex-col py-4'>
              ...
              <button className='bg-red-600 my-6 rounded py-3 font-bold'>Sign Up</button>
            <div className='flex justify-between text-sm text-gray-600'>
              <p><input className='mr-2' type="checkbox" />Remember Me</p>
              <p>Need Help?</p>
            </div>
            <p className='py-8'><span className='text-gray-600 mr-1'>Already Subscribed to Netflix?</span>
            <Link to='/login'>
            Sign In
            </Link>
            </p>
